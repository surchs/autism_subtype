...
pheno_p = root_p / 'pheno/ABIDE1_Pheno_prepared_motion.tsv'
pheno_qc_p = root_p / 'pheno/ABIDE1_Pheno_QC.tsv'
pheno_qc_pass_p = root_p / 'pheno/ABIDE1_Pheno_QC_pass.tsv'
report_d = pal.Path('/home/surchs/ABIDE_1_QC_Reports')
...
# Create a new column to collapse subsites into one site
available_site_pheno.loc[:, ('site_collapse')] = [row['site_name'].split('_')[0] for rid, row in available_site_pheno.iterrows()]
