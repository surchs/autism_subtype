...
singularity run -B ${data_root},${proj_root} /home/surchs/singularity/abide_subtype_0_1.simg python ${proj_root}/scripts/preprocessing/hnu_1_niak_scrubbing.py -n_cpu ${cpu}
