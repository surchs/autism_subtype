...
singularity run -B ${data_root},${proj_root},${atlas_root} /home/surchs/singularity/abide_subtype_0_1.simg python ${proj_root}/scripts/stability/hnu_1_weight_stability_fixed_subtypes.py ${scale} -n_cpu ${cpu}
